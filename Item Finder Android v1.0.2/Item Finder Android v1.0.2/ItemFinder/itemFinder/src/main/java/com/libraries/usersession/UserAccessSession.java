...
public class UserAccessSession {
	...
	private static final String PHONE_NO 		= "7878lk68klkkkkkkk";
	private static final String SMS_NO 			= "45690435930dddddd";
	...
	public void storeUserSession(UserSession session) {
		...
		editor.putString(SMS_NO, session.getSms_no());
		editor.putString(PHONE_NO, session.getPhone_no());
	...
	public void clearUserSession() {
		...
		editor.putString(SMS_NO, null);
		editor.putString(PHONE_NO, null);
		editor.commit();
	}
	...
	public UserSession getUserSession() {
		...
		session.setSms_no( sharedPref.getString(SMS_NO, null) );
		session.setPhone_no( sharedPref.getString(PHONE_NO, null) );
		return session;
	}
