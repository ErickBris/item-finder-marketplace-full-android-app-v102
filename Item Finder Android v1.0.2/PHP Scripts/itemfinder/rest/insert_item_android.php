<?php
  ...
  if(!$controllerUser->isUserIdExistAndHash($user_id, $login_hash) || Constants::API_KEY != $api_key) {
      ...
      if($item_id > 0) {
          ...
          $catJson = $jsonFormatter->getCategoryAndroid($cat);
          ...
          $json = "{\"status\":{\"status_code\":\"-1\",\"status_text\":\"Success.\"},\"item_details\":{\"item_info\":$itemJson,\"photos\":$strPhotos,\"user\":$strUser,\"category\":$catJson}}";
          echo $json;
      }
